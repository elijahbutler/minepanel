...
export const de: Record<TranslationKey, string> = {
  ...
  shutdownBroadcastMessage: 'Warnung beim Herunterfahren',
  shutdownBroadcastPlaceholder: 'Der Server wird in {seconds} Sekunden heruntergefahren.',
  shutdownBroadcastMessageHelp: 'Wird zu Beginn eines regulären Stopps oder Neustarts gesendet. Verwende {seconds} für die eingestellte Verzögerung. Leer lassen, um die Standardwarnung zu verwenden.',
  ...
  backupBroadcastMessage: 'Backup-Warnung',
  backupBroadcastPlaceholder: 'Das Welt-Backup startet. Es kann kurz zu einer Pause kommen.',
  backupBroadcastMessageHelp: 'Wird gesendet, bevor die Weltspeicherung für ein Backup pausiert wird. Leer lassen, um keine Nachricht zu senden.',
  ...
  modrinthPluginProjects: 'Modrinth-Plugins',
  modrinthPluginProjectsHelp:
    'Suche nach Namen oder füge einen Modrinth-Plugin-Link ein. Die Ergebnisse werden nach Minecraft-Version und Paper gefiltert. MinePanel speichert den ausgewählten Slug oder die ID in MODRINTH_PROJECTS.',
  modrinthPluginProjectsDesc: 'Paper-Plugins beim Serverstart von Modrinth installieren und aktualisieren',
  browsePlugins: 'Plugins durchsuchen',
  searchPlugins: 'Plugins suchen',
  searchPluginsPlaceholder: 'Plugins suchen oder einen Modrinth-Link einfügen',
  searchPluginsDesc: 'Ergebnisse gefiltert nach Paper und Minecraft-Version:',
  addPlugin: 'Plugin hinzufügen',
  removePlugin: 'Plugin entfernen',
  pluginAlreadyAdded: 'Dieses Plugin ist bereits in der Liste',
  noCompatiblePluginsFound: 'Keine kompatiblen Plugins mit den aktuellen Filtern gefunden',
  errorSearchingPlugins: 'Fehler bei der Plugin-Suche',
  filterPluginsPlaceholder: 'Plugins nach Name oder ID filtern',
  noPluginsMatchFilter: 'Keine Plugins entsprechen diesem Filter',
  pluginsListEmpty: 'Noch keine Modrinth-Plugins hinzugefügt',
  pluginsListEmptyHint: 'Mit "Plugins suchen" die neueste kompatible Version hinzufügen.',
  pluginsCount: 'Plugins',
  pluginOptionalHelp: 'Server weiter starten, wenn dieses Plugin keine kompatible Version hat',
  ...
  worldsRestartNoticeRunning: 'Die aktive Welt wird nicht verändert. Speichern Sie die Auswahl jetzt, damit sie nach dem nächsten Neustart angewendet wird.',
  allLabel: 'Alle',
