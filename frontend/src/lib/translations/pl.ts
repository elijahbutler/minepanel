...
export const pl: Record<TranslationKey, string> = {
  ...
  shutdownBroadcastMessage: 'Ostrzeżenie o wyłączeniu',
  shutdownBroadcastPlaceholder: 'Serwer zostanie wyłączony za {seconds} s.',
  shutdownBroadcastMessageHelp: 'Wysyłane na początku zwykłego zatrzymania lub restartu. Użyj {seconds}, aby wstawić ustawione opóźnienie. Pozostaw puste, aby użyć domyślnego ostrzeżenia.',
  ...
  backupBroadcastMessage: 'Ostrzeżenie o kopii zapasowej',
  backupBroadcastPlaceholder: 'Rozpoczyna się tworzenie kopii świata. Może wystąpić krótka przerwa.',
  backupBroadcastMessageHelp: 'Wysyłane przed wstrzymaniem zapisu świata na czas tworzenia kopii. Pozostaw puste, aby nic nie wysyłać.',
  ...
  modrinthPluginProjects: 'Wtyczki Modrinth',
  modrinthPluginProjectsHelp:
    'Wyszukaj nazwę lub wklej link do wtyczki Modrinth. Wyniki są filtrowane według wersji Minecraft serwera i Paper. MinePanel zapisuje wybrany identyfikator w MODRINTH_PROJECTS.',
  modrinthPluginProjectsDesc: 'Instaluj i aktualizuj wtyczki Paper z Modrinth przy starcie serwera',
  browsePlugins: 'Przeglądaj wtyczki',
  searchPlugins: 'Szukaj wtyczek',
  searchPluginsPlaceholder: 'Szukaj wtyczek lub wklej link Modrinth',
  searchPluginsDesc: 'Wyniki filtrowane dla Paper i wersji Minecraft:',
  addPlugin: 'Dodaj wtyczkę',
  removePlugin: 'Usuń wtyczkę',
  pluginAlreadyAdded: 'Ta wtyczka jest już na liście',
  noCompatiblePluginsFound: 'Nie znaleziono zgodnych wtyczek dla bieżących filtrów',
  errorSearchingPlugins: 'Błąd podczas wyszukiwania wtyczek',
  filterPluginsPlaceholder: 'Filtruj wtyczki według nazwy lub ID',
  noPluginsMatchFilter: 'Żadna wtyczka nie pasuje do tego filtra',
  pluginsListEmpty: 'Nie dodano jeszcze wtyczek Modrinth',
  pluginsListEmptyHint: 'Użyj "Szukaj wtyczek", aby dodać najnowszą zgodną wersję.',
  pluginsCount: 'wtyczek',
  pluginOptionalHelp: 'Kontynuuj start serwera, gdy ta wtyczka nie ma zgodnej wersji',
