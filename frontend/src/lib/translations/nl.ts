...
export const nl: Record<TranslationKey, string> = {
  ...
  modrinthPluginProjectsHelp:
    'Zoek op naam of plak een Modrinth-pluginlink. Resultaten worden gefilterd op de Minecraft-versie van de server en Paper. MinePanel slaat de gekozen slug of ID op in MODRINTH_PROJECTS.',
  modrinthPluginProjectsDesc: 'Installeer en update Paper-plugins vanaf Modrinth wanneer de server start',
  browsePlugins: 'Plugins bekijken',
  searchPlugins: 'Plugins zoeken',
  searchPluginsPlaceholder: 'Zoek plugins of plak een Modrinth-link',
  searchPluginsDesc: 'Resultaten gefilterd op Paper en Minecraft-versie:',
  addPlugin: 'Plugin toevoegen',
  removePlugin: 'Plugin verwijderen',
  pluginAlreadyAdded: 'Deze plugin staat al in de lijst',
  noCompatiblePluginsFound: 'Geen compatibele plugins gevonden met de huidige filters',
  errorSearchingPlugins: 'Fout bij het zoeken naar plugins',
  filterPluginsPlaceholder: 'Filter plugins op naam of ID',
  noPluginsMatchFilter: 'Geen plugins komen overeen met dit filter',
  pluginsListEmpty: 'Nog geen Modrinth-plugins toegevoegd',
  pluginsListEmptyHint: 'Gebruik "Plugins zoeken" om de nieuwste compatibele versie toe te voegen.',
  pluginsCount: 'plugins',
  pluginOptionalHelp: 'Start de server verder wanneer deze plugin geen compatibele versie heeft',
  ...
  copyServerAddress: 'Serveradres kopiëren',
  serverAddressUnavailable: 'Geen serveradres beschikbaar',
  proxyAddress: 'Proxyhostnaam',
