...
export const es: Record<TranslationKey, string> = {
  ...
  shutdownBroadcastMessage: 'Aviso de apagado',
  shutdownBroadcastPlaceholder: 'El servidor se apagará en {seconds} segundos.',
  shutdownBroadcastMessageHelp: 'Se envía al comenzar una detención o reinicio normal. Usa {seconds} para el retardo configurado. Deja el campo vacío para usar el aviso predeterminado.',
  ...
  backupBroadcastMessage: 'Aviso de copia de seguridad',
  backupBroadcastPlaceholder: 'La copia del mundo va a comenzar. Puede haber una pausa breve.',
  backupBroadcastMessageHelp: 'Se envía antes de pausar el guardado del mundo para crear la copia. Déjalo vacío para no enviar ningún aviso.',
  ...
  modrinthPluginProjects: 'Plugins de Modrinth',
  modrinthPluginProjectsHelp:
    'Busca por nombre o pega un enlace de plugin de Modrinth. Los resultados se filtran por la versión de Minecraft del servidor y Paper. MinePanel guarda el slug o ID seleccionado en MODRINTH_PROJECTS.',
  modrinthPluginProjectsDesc: 'Instala y actualiza plugins de Paper desde Modrinth al iniciar el servidor',
  browsePlugins: 'Explorar plugins',
  searchPlugins: 'Buscar plugins',
  searchPluginsPlaceholder: 'Busca plugins o pega un enlace de Modrinth',
  searchPluginsDesc: 'Resultados filtrados para Paper y la versión de Minecraft:',
  addPlugin: 'Añadir plugin',
  removePlugin: 'Eliminar plugin',
  pluginAlreadyAdded: 'Este plugin ya está en la lista',
  noCompatiblePluginsFound: 'No se encontraron plugins compatibles con los filtros actuales',
  errorSearchingPlugins: 'Error al buscar plugins',
  filterPluginsPlaceholder: 'Filtrar plugins por nombre o ID',
  noPluginsMatchFilter: 'Ningún plugin coincide con este filtro',
  pluginsListEmpty: 'Aún no hay plugins de Modrinth',
  pluginsListEmptyHint: 'Usa "Buscar plugins" para añadir la versión compatible más reciente.',
  pluginsCount: 'plugins',
  pluginOptionalHelp: 'Sigue iniciando el servidor cuando este plugin no tiene una versión compatible',
