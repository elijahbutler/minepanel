...
export const es: Record<TranslationKey, string> = {
  ...
  copyServerAddress: 'Copiar dirección del servidor',
  serverAddressUnavailable: 'No hay una dirección de servidor disponible',
  proxyAddress: 'Nombre de host del proxy',
