export const en = {
  ...
  shutdownBroadcastMessage: 'Shutdown warning',
  shutdownBroadcastPlaceholder: 'Server shutting down in {seconds} seconds.',
  shutdownBroadcastMessageHelp: 'Sent when a graceful stop or restart begins. Use {seconds} for the configured delay. Leave blank for the default warning.',
  ...
  backupBroadcastMessage: 'Backup warning',
  backupBroadcastPlaceholder: 'World backup starting. You may notice a brief pause.',
  backupBroadcastMessageHelp: 'Sent before world saves are paused for a backup. Leave blank to send nothing.',
  ...
  modrinthPluginProjectsHelp:
    "Search by name or paste a Modrinth plugin link. Results are filtered for the server's Minecraft version and Paper. MinePanel stores the selected slug or ID in MODRINTH_PROJECTS.",
  modrinthPluginProjectsDesc: 'Install and update Paper plugins from Modrinth when the server starts',
  browsePlugins: 'Browse plugins',
  searchPlugins: 'Search plugins',
  searchPluginsPlaceholder: 'Search plugins or paste a Modrinth link',
  searchPluginsDesc: 'Results filtered for Paper and Minecraft version:',
  addPlugin: 'Add plugin',
  removePlugin: 'Remove plugin',
  pluginAlreadyAdded: 'This plugin is already in the list',
  noCompatiblePluginsFound: 'No compatible plugins found with current filters',
  errorSearchingPlugins: 'Error searching plugins',
  filterPluginsPlaceholder: 'Filter plugins by name or ID',
  noPluginsMatchFilter: 'No plugins match this filter',
  pluginsListEmpty: 'No Modrinth plugins added yet',
  pluginsListEmptyHint: 'Use "Search plugins" to add the latest compatible release.',
  pluginsCount: 'plugins',
  pluginOptionalHelp: 'Keep starting the server when this plugin has no compatible version',
